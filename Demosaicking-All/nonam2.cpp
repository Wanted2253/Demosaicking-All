...
void demosaic_nona(cv::Mat& Bayer, cv::Mat& Dst, float sigma = 1.0) {
	...
	Mat rawH = method2_h(Src1ch);
    Mat rawV = method2_v(Src1ch);
    ...
    residualGr_H = method2_h(residualGr_H);
    residualGb_H = method2_h(residualGb_H);
    residualR_H = method2_h(residualR_H);
    residualB_H = method2_h(residualB_H);
    residualGr_V = method2_v(residualGr_V);
    residualGb_V = method2_v(residualGb_V);
    residualR_V = method2_v(residualR_V);
    residualB_V = method2_v(residualB_V);
